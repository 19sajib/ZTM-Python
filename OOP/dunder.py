...
print(hulk.__call__())
print(hulk())   # with call method, we get this special power to call a method with brackets
...
'''
### all those dunder methods changed for that Toy class not for all class